            ...
            <div class="bg-gradient-to-r from-amber-600 to-amber-700 rounded-xl shadow-lg p-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-amber-100 mt-1">Kelola perpindahan karyawan antar cabang</p>
                    </div>
                ...
                <Table>
                    <template #header>
                        <TableRow class="bg-amber-500">
                            ...
                            <TableHeaderCell class="text-white">CABANG ASAL</TableHeaderCell>
                            <TableHeaderCell class="text-white">CABANG TUJUAN</TableHeaderCell>
                            <TableHeaderCell class="text-white">TANGGAL MUTASI</TableHeaderCell>
                            <TableHeaderCell class="text-white">AKSI</TableHeaderCell>
                        </TableRow>
                    </template>
                    <template #default>
                        <TableRow v-for="(data, index) in fetchData" :key="data.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-amber-50 dark:hover:bg-gray-600 transition-colors duration-150">
