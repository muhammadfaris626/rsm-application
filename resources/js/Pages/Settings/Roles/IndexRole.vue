<script setup>
    ...
    defineProps(["fetchData", "permissions"]);
    const form = useForm({
        id: "",
        name: "",
        permissions: []
...
<template>
    ...
    <AuthenticatedLayout>
        <div class="grid grid-cols-1 h-full space-y-6">
            <!-- Header Card -->
            <div class="bg-gradient-to-r from-amber-600 to-amber-700 rounded-xl shadow-lg p-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-bold">Peran</h1>
                        <p class="text-amber-100 mt-1">Kelola peran dan hak akses pengguna</p>
                    </div>
                    ...
                    <div class="w-full md:w-1/3">
                        <div class="relative group">
                            <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 text-gray-400 group-focus-within:text-amber-600 transition-colors">
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                <Table>
                    ...
                    <template #default>
                        <TableRow v-for="(data, index) in fetchData.data" :key="data.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-amber-50 dark:hover:bg-gray-600 transition-colors duration-150">
                            ...
                            <TableDataCell :status="'action'">
                                <!-- Lihat Data  -->
                                <template v-if="hasPermission('role: read')">
                                    <Link 
                                ...
                                <!-- Ubah Data  -->
                                <template v-if="hasPermission('role: update')">
                                    <button 
                                ...
                                <!-- Hapus Data  -->
                                <template v-if="hasPermission('role: delete')">
                                    <button 
