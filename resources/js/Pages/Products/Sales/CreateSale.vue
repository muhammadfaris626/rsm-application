...
<template>
    ...
    <AuthenticatedLayout>
        <div class="grid grid-cols-1 h-full">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <Link :href="route('sales.index')" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Data Penjualan</Link>
                            </div>
                        </li>
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Tambah Penjualan</span>
                            </div>
                        </li>
                    </ol>
                </nav>
            ...
            <div class="pt-4">
                <h1 class="text-xl font-semibold text-blue-600">TAMBAH PENJUALAN</h1>
                <form @submit.prevent="form.post(route('sales.store'))">
                        ...
                        <div v-if="form.products.length > 0" class="relative flex flex-col rounded-lg bg-white shadow-sm border border-slate-200 mb-4">
                            <nav class="flex flex-col gap-1 p-1.5">
                                <div v-for="(product, index) in form.products" :key="index">
                                    <div class="text-slate-800 flex w-full items-center rounded-md pt-2 pl-3 transition-all">
                                    ...
                                    <table v-if="product.branch_product_id?.stock != null" class="table-auto text-xs ml-12 text-gray-500">
                                        <tbody>
                                            <tr>
                                                <td>Stok Tersedia</td>
                                                <td>:</td>
                                                <td>{{ product.branch_product_id.stock }}</td>
                                            </tr>
                                            <tr>
                                                <td>Tanggal Barang</td>
                                                <td>:</td>
                                                <td>{{ product.branch_product_id.tanggal }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                    ...
                    <div class="mt-6">
                        ...
                        <Link :href="route('sales.index')" class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 focus:outline-none dark:focus:ring-red-800">KEMBALI</Link>
                    </div>
                </form>
            </div>
        </div>
