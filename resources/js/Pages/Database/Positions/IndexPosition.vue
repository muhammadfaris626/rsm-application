        ...
        <div class="grid grid-cols-1 h-full space-y-6">
            ...
            <div class="bg-gradient-to-r from-purple-600 to-purple-700 rounded-xl shadow-lg p-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-bold">Jabatan</h1>
                        <p class="text-purple-100 mt-1">Kelola posisi dan jabatan karyawan</p>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-md p-4">
                <div class="flex flex-col md:flex-row justify-between gap-4">
                    ...
                    <div>
                        <template v-if="hasPermission('position: create')">
                            <button 
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                <Table>
                    <template #header>
                        <TableRow class="bg-purple-500">
                            <TableHeaderCell class="text-white">NO</TableHeaderCell>
                            <TableHeaderCell class="text-white">NAMA JABATAN</TableHeaderCell>
                    ...
                    <template #default>
                        <TableRow v-for="(data, index) in fetchData.data" :key="data.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-purple-50 dark:hover:bg-gray-600 transition-colors duration-150">
                            ...
                            <TableDataCell :status="'record'">{{ data.position_name }}</TableDataCell>
                            <TableDataCell :status="'action'">
                                <template v-if="hasPermission('position: read')">
                                    <button 
                                ...
                                <template v-if="hasPermission('position: update')">
                                    <button 
                                ...
                                <template v-if="hasPermission('position: delete')">
                                    <button 
            ...
            <Modal :show="showModalCreate" @close="closeModalCreate">
                <div class="relative w-full max-w-5xl max-h-full bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <form @submit.prevent="tambahData">
                        <div class="px-4 py-2">
                            <div class="mb-2">
                                <label for="position_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Jabatan</label>
                                <input v-model="form.position_name" type="text" id="position_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"/>
