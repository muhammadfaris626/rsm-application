        ...
        <div class="grid grid-cols-1 h-full space-y-6">
            ...
            <div class="bg-gradient-to-r from-teal-600 to-teal-700 rounded-xl shadow-lg p-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-bold">Operasional Cabang</h1>
                        <p class="text-teal-100 mt-1">Kelola operasional dan biaya di setiap cabang</p>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-md p-4">
                <div class="flex flex-col md:flex-row justify-between gap-4">
                    ...
                    <div>
                        <template v-if="hasPermission('operational-branch: create')">
                            <button 
                        ...
                        <TableRow v-for="(data, index) in fetchData.data" :key="data.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-teal-50 dark:hover:bg-gray-600 transition-colors duration-150">
                            ...
                            <TableDataCell :status="'action'">
                                <div class="flex items-center gap-2">
                                    <!-- Lihat Data  -->
                                    <template v-if="hasPermission('operational-branch: read')">
                                        <button 
                                    ...
                                    <!-- Ubah Data  -->
                                    <template v-if="hasPermission('operational-branch: update')">
                                        <button 
                                    ...
                                    <!-- Hapus Data  -->
                                    <template v-if="hasPermission('operational-branch: delete')">
                                        <button 
                    ...
                    <div class="relative w-full max-w-5xl max-h-full bg-white rounded-lg shadow dark:bg-gray-700">
                        <div class="p-4 md:p-5 text-center">
                            ...
                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                                Apakah anda yakin ingin menghapus operasional cabang ini ?
                            </h3>
