...
<template>
    <Head title="Tambah Pembelian Persediaan" />
    <AuthenticatedLayout>
        <div class="space-y-6">
            <!-- Header Section -->
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div>
                    <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">Tambah Pembelian Persediaan</h1>
                    <p class="text-sm sm:text-base text-gray-600 dark:text-gray-400 mt-1">Tambah data pembelian persediaan baru</p>
                </div>
                <div>
            ...
            <form @submit.prevent="form.post(route('inventoryPurchases.store'))">
                <!-- Informasi Pembelian -->
