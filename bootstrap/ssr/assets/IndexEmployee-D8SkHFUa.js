import { ref, computed, watch, unref, withCtx, createVNode, withModifiers, withDirectives, vModelSelect, createTextVNode, toDisplayString, createBlock, createCommentVNode, openBlock, Fragment, renderList, isRef, vModelText, useSSRContext } from "vue";
import { ssrRenderComponent, ssrRenderAttr, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrRenderClass, ssrRenderList, ssrInterpolate } from "vue/server-renderer";
            ...
            return [
              createVNode("div", { class: "grid grid-cols-1 h-full" }, [
                    ...
                    createVNode("ol", { class: "inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse" }, [
                      ...
                      createVNode("li", { "aria-current": "page" }, [
                        createVNode("div", { class: "flex items-center" }, [
                          ...
                          createVNode("span", { class: "ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400" }, "Karyawan")
                        ])
                      ])
                    ])
                  ])
                ...
                createVNode("div", { class: "flex justify-between my-3" }, [
                  ...
                  createVNode("div", null, [
                    unref(hasPermission)("employee: create") ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                      createVNode("button", {
