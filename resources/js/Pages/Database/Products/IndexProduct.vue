<script setup>
    ...
    const search = useDebouncedTableSearch('products.index', usePage().props.search);
            ...
            <div class="bg-gradient-to-r from-emerald-600 to-emerald-700 rounded-xl shadow-lg p-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-emerald-100 mt-1">Kelola data produk dan barang</p>
                    </div>
                ...
                <Table>
                    <template #header>
                        <TableRow class="bg-emerald-500">
                            ...
                            <TableHeaderCell class="text-white">KATEGORI BARANG</TableHeaderCell>
                            <TableHeaderCell class="text-white">NAMA BARANG</TableHeaderCell>
                    ...
                    <template #default>
                        <TableRow v-for="(data, index) in fetchData.data" :key="data.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-emerald-50 dark:hover:bg-gray-600 transition-colors duration-150">
                            ...
                            <TableDataCell :status="'action'">
                                ...
                                <template v-if="hasPermission('product: update')">
                                    <button 
                                ...
                                <template v-if="hasPermission('product: delete')">
                                    <button 
                ...
                <div class="relative w-full max-w-5xl max-h-full bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <form @submit.prevent="tambahData">
                        <div class="grid grid-cols-1 gap-2 px-4 py-2">
                            <div>
                                <InputLabel for="product_category_id" value="Kategori Barang" />
                                <VueMultiselect
                            ...
                            <div>
                                <InputLabel for="product_name" value="Nama Barang" />
                                <TextInput
                                    id="product_name"
                                    type="text"
