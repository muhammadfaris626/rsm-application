...
<template>
    ...
    <AuthenticatedLayout>
        <div class="grid grid-cols-1 h-full">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Tambah Pembeliaan Persediaan</span>
                            </div>
                        </li>
                    </ol>
                </nav>
            ...
            <div class="pt-4">
                <h1 class="text-xl font-semibold text-blue-600">TAMBAH PEMBELIAN PERSEDIAAN</h1>
