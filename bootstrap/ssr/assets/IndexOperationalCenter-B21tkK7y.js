...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  __name: "IndexOperationalCenter",
  __ssrInlineRender: true,
  props: ["fetchData", "expenditures"],
  setup(__props) {
    const form = useForm({
      id: "",
      date: "",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
                  ...
                  return [
                    createVNode("div", { class: "relative w-full max-w-5xl max-h-full bg-white rounded-lg shadow dark:bg-gray-700" }, [
                      createVNode("div", { class: "flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600" }, [
                        createVNode("h3", { class: "text-xl font-semibold text-gray-900 dark:text-white" }, " TAMBAH OPERASIONAL PUSAT ")
                      ]),
                      createVNode("form", {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          ...
                          _push4(ssrRenderComponent(_sfc_main$8, { status: "record" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold bg-emerald-100 text-emerald-800"${_scopeId4}>${ssrInterpolate(formatRupiah(data.total_cost))}</span>`);
                              } else {
                                return [
                                  createVNode("span", { class: "inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold bg-emerald-100 text-emerald-800" }, toDisplayString(formatRupiah(data.total_cost)), 1)
                                ];
                              }
                            }),
                            _: 2
                          ...
                          _push4(ssrRenderComponent(_sfc_main$8, { status: "action" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                ...
                                if (unref(hasPermission)("operational-center: read")) {
                                ...
                                if (unref(hasPermission)("operational-center: update")) {
                                ...
                                if (unref(hasPermission)("operational-center: delete")) {
                                ...
                                return [
                                  createVNode("div", { class: "flex items-center gap-2" }, [
                                    unref(hasPermission)("operational-center: read") ? (openBlock(), createBlock("button", {
                                      key: 0,
                                    ...
                                    unref(hasPermission)("operational-center: update") ? (openBlock(), createBlock("button", {
                                      key: 1,
                                    ...
                                    unref(hasPermission)("operational-center: delete") ? (openBlock(), createBlock("button", {
                                      key: 2,
            ...
            _push2(ssrRenderComponent(_sfc_main$2, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="relative w-full max-w-5xl max-h-full bg-white rounded-lg shadow dark:bg-gray-700"${_scopeId2}><div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600"${_scopeId2}><h3 class="text-xl font-semibold text-gray-900 dark:text-white"${_scopeId2}> UBAH OPERASIONAL PUSAT </h3></div><form${_scopeId2}><div class="grid grid-cols-2 gap-2 px-4 py-2"${_scopeId2}><div${_scopeId2}>`);
                  _push3(ssrRenderComponent(_sfc_main$3, {
                    for: "date",
                    value: "Tanggal"
                  }, null, _parent3, _scopeId2));
                  ...
                  return [
                    createVNode("div", { class: "relative w-full max-w-5xl max-h-full bg-white rounded-lg shadow dark:bg-gray-700" }, [
                      createVNode("div", { class: "flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600" }, [
                        createVNode("h3", { class: "text-xl font-semibold text-gray-900 dark:text-white" }, " UBAH OPERASIONAL PUSAT ")
                      ]),
                      createVNode("form", {
                  ...
                  return [
                    createVNode("div", { class: "relative w-full max-w-5xl max-h-full bg-white rounded-lg shadow dark:bg-gray-700" }, [
                      createVNode("div", { class: "p-4 md:p-5 text-center" }, [
                        ...
                        createVNode("h3", { class: "mb-5 text-lg font-normal text-gray-500 dark:text-gray-400" }, " Apakah anda yakin ingin menghapus operasional pusat ini ? "),
                        createVNode("button", {
                          onClick: hapusData,
                          type: "button",
              ...
              createVNode("div", { class: "grid grid-cols-1 h-full space-y-6" }, [
                createVNode("div", { class: "bg-gradient-to-r from-emerald-600 to-emerald-700 rounded-xl shadow-lg p-6 text-white" }, [
                  createVNode("div", { class: "flex items-center justify-between" }, [
                    createVNode("div", null, [
                      createVNode("h1", { class: "text-2xl font-bold" }, "Operasional Pusat"),
                      createVNode("p", { class: "text-emerald-100 mt-1" }, "Kelola operasional dan biaya di pusat")
                    ]),
                ...
                createVNode("div", { class: "bg-white rounded-xl shadow-md p-4" }, [
                  createVNode("div", { class: "flex flex-col md:flex-row justify-between gap-4" }, [
                    createVNode("div", { class: "w-full md:w-1/3" }, [
                      createVNode("div", { class: "relative group" }, [
                        ...
                        withDirectives(createVNode("input", {
                          ...
                          placeholder: "Cari jenis biaya, total biaya, atau pembuat..."
                    ...
                    createVNode("div", null, [
                      unref(hasPermission)("operational-center: create") ? (openBlock(), createBlock("button", {
                        key: 0,
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Operationals/Centers/IndexOperationalCenter.vue");
