...
<template>
    ...
    <AuthenticatedLayout>
        <div class="grid grid-cols-1 h-full">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <Link :href="route('terminations.index')" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Data Pemberhentian</Link>
                            </div>
                        </li>
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Tambah Pemberhentian</span>
                            </div>
                        </li>
                    </ol>
                </nav>
            ...
            <div class="pt-4">
                <h1 class="text-xl font-semibold text-blue-600">TAMBAH PEMBERHENTIAN</h1>
                <form @submit.prevent="form.post(route('terminations.store'))">
                    <div class="grid grid-cols-3 gap-2 mt-2 bg-white p-4 rounded-xl">
                        ...
                        <div>
                            <InputLabel for="termination_date" value="Tanggal Pemberhentian" />
                            <TextInput
                                id="termination_date"
                                type="date"
                        ...
                        <div class="col-span-2">
                            <InputLabel for="reason" value="Keterangan Pemberhentian" />
