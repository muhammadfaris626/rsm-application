                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Barang Cabang</span>
                            </div>
                        </li>
                    </ol>
                </nav>
            ...
            <Table>
                ...
                <template #default>
                    <TableRow v-for="(data, index) in fetchData.data" :key="data.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <TableDataCell :status="'record'">{{ data.branch.branch_name }}</TableDataCell>
                        <TableDataCell :status="'record'">{{ data.product.product_name }}</TableDataCell>
                        <TableDataCell :status="'record'">{{ data.total_stock }}</TableDataCell>
                        <TableDataCell :status="'record'">{{ data.latest_created_at }}</TableDataCell>
