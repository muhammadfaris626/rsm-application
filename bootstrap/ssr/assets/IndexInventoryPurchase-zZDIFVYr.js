import { ref, computed, watch, unref, withCtx, createBlock, createTextVNode, openBlock, createVNode, toDisplayString, createCommentVNode, Fragment, renderList, withDirectives, isRef, vModelText, useSSRContext } from "vue";
  ...
  setup(__props) {
    ...
    const calculateTotalPrice = (listData) => {
      return listData.reduce((accumulator, item) => {
        return accumulator + parseInt(item.total_price, 10);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                              ...
                              if (_push5) {
                                _push5(ssrRenderComponent(unref(Link), {
                                  ...
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`${ssrInterpolate(data.invoice_number)}`);
                                    } else {
                                      return [
                          ...
                          _push4(ssrRenderComponent(_sfc_main$3, { status: "record" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`${ssrInterpolate(data.supplier_id[0]["name"])}`);
                              } else {
                                return [
                                  createTextVNode(toDisplayString(data.supplier_id[0]["name"]), 1)
                                ];
                              }
                            }),
                            _: 2
                          ...
                          _push4(ssrRenderComponent(_sfc_main$3, { status: "record" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`${ssrInterpolate(calculateTotalPrice(data.listData))}`);
                              } else {
                                return [
                                  createTextVNode(toDisplayString(calculateTotalPrice(data.listData)), 1)
                                ];
                              }
                            }),
                            _: 2
                              ...
                              if (_push5) {
                                ...
                                if (unref(hasPermission)("inventory-purchase: update")) {
                                  _push5(ssrRenderComponent(unref(Link), {
                                    ...
                                    default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-3 h-3"${_scopeId5}><path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10"${_scopeId5}></path></svg>`);
                                      } else {
                                        return [
                                          (openBlock(), createBlock("svg", {
                                            xmlns: "http://www.w3.org/2000/svg",
            ...
            _push2(ssrRenderComponent(_sfc_main$4, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="relative w-full max-w-5xl max-h-full bg-white rounded-lg shadow dark:bg-gray-700"${_scopeId2}><div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600"${_scopeId2}><h3 class="text-xl font-semibold text-gray-900 dark:text-white"${_scopeId2}> TAMPILKAN PEMBELIAN PERSEDIAAN </h3></div><div class="py-2"${_scopeId2}><div class="relative overflow-x-auto"${_scopeId2}><table class="table-collapse w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400"${_scopeId2}><tbody${_scopeId2}><tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700"${_scopeId2}><th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white"${_scopeId2}> ID </th><td class="px-6 py-4"${_scopeId2}>${ssrInterpolate(unref(form).id)}</td></tr><tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700"${_scopeId2}><th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white"${_scopeId2}> NOMOR FAKTUR </th><td class="px-6 py-4"${_scopeId2}>${ssrInterpolate(unref(form).invoice_number)}</td></tr><tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700"${_scopeId2}><th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white"${_scopeId2}> TANGGAL </th><td class="px-6 py-4"${_scopeId2}>${ssrInterpolate(formatTanggal(unref(form).date))}</td></tr><tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700"${_scopeId2}><th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white"${_scopeId2}> SUPPLIER </th><td class="px-6 py-4"${_scopeId2}>${ssrInterpolate(unref(form).supplier_id[0]["name"])}</td></tr><tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700"${_scopeId2}><th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white"${_scopeId2}> BARANG </th><td class="px-6 py-4"${_scopeId2}><table class="border-collapse border border-gray-400"${_scopeId2}><thead${_scopeId2}><tr${_scopeId2}><th class="border border-gray-300 px-2"${_scopeId2}>No</th><th class="border border-gray-300 px-2"${_scopeId2}>Nama Barang</th><th class="border border-gray-300 px-2"${_scopeId2}>Harga Barang</th><th class="border border-gray-300 px-2"${_scopeId2}>Jumlah Barang</th><th class="border border-gray-300 px-2"${_scopeId2}>Total Harga</th></tr></thead><tbody${_scopeId2}><!--[-->`);
                  ssrRenderList(unref(form).listData, (list, index) => {
                    _push3(`<tr${_scopeId2}><td class="border border-gray-300 px-2 text-center"${_scopeId2}>${ssrInterpolate(index + 1)}</td><td class="border border-gray-300 px-2"${_scopeId2}>${ssrInterpolate(list.product.product_name)}</td><td class="border border-gray-300 px-2"${_scopeId2}>${ssrInterpolate(formatRupiah(list.price))}</td><td class="border border-gray-300 px-2 text-center"${_scopeId2}>${ssrInterpolate(list.quantity)}</td><td class="border border-gray-300 px-2"${_scopeId2}>${ssrInterpolate(formatRupiah(list.total_price))}</td></tr>`);
                  });
                  _push3(`<!--]--></tbody></table></td></tr><tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700"${_scopeId2}><th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white"${_scopeId2}> TOTAL HARGA </th><td class="px-6 py-4"${_scopeId2}>${ssrInterpolate(calculateTotalPrice(unref(form).listData))}</td></tr><tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700"${_scopeId2}><th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white"${_scopeId2}> DIUBAH OLEH </th><td class="px-6 py-4"${_scopeId2}>${ssrInterpolate(unref(form).last_update.user.name)}</td></tr><tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700"${_scopeId2}><th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white"${_scopeId2}> TANGGAL DIBUAT </th><td class="px-6 py-4"${_scopeId2}>${ssrInterpolate(unref(form).created_at)}</td></tr><tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700"${_scopeId2}><th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white"${_scopeId2}> TANGGAL DIUBAH </th><td class="px-6 py-4"${_scopeId2}>${ssrInterpolate(unref(form).updated_at)}</td></tr></tbody></table></div></div></div>`);
                } else {
                  return [
                    createVNode("div", { class: "relative w-full max-w-5xl max-h-full bg-white rounded-lg shadow dark:bg-gray-700" }, [
                      createVNode("div", { class: "flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600" }, [
                        createVNode("h3", { class: "text-xl font-semibold text-gray-900 dark:text-white" }, " TAMPILKAN PEMBELIAN PERSEDIAAN ")
                      ]),
                          ...
                          createVNode("table", { class: "table-collapse w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400" }, [
                            createVNode("tbody", null, [
                              ...
                              createVNode("tr", { class: "bg-white border-b dark:bg-gray-800 dark:border-gray-700" }, [
                                ...
                                createVNode("td", { class: "px-6 py-4" }, toDisplayString(unref(form).invoice_number), 1)
                              ]),
                              createVNode("tr", { class: "bg-white border-b dark:bg-gray-800 dark:border-gray-700" }, [
                                createVNode("th", {
                                  scope: "row",
                              ...
                              createVNode("tr", { class: "bg-white border-b dark:bg-gray-800 dark:border-gray-700" }, [
                                ...
                                createVNode("td", { class: "px-6 py-4" }, toDisplayString(unref(form).supplier_id[0]["name"]), 1)
                              ]),
                              createVNode("tr", { class: "bg-white border-b dark:bg-gray-800 dark:border-gray-700" }, [
                                createVNode("th", {
                                  scope: "row",
                                  ...
                                  createVNode("table", { class: "border-collapse border border-gray-400" }, [
                                    createVNode("thead", null, [
                                      createVNode("tr", null, [
                                        ...
                                        createVNode("th", { class: "border border-gray-300 px-2" }, "Harga Barang"),
                                        createVNode("th", { class: "border border-gray-300 px-2" }, "Jumlah Barang"),
                                        createVNode("th", { class: "border border-gray-300 px-2" }, "Total Harga")
                                      ])
                                    ]),
                                    createVNode("tbody", null, [
                                      (openBlock(true), createBlock(Fragment, null, renderList(unref(form).listData, (list, index) => {
                                        return openBlock(), createBlock("tr", {
                                          ...
                                          createVNode("td", { class: "border border-gray-300 px-2" }, toDisplayString(list.product.product_name), 1),
                                          createVNode("td", { class: "border border-gray-300 px-2" }, toDisplayString(formatRupiah(list.price)), 1),
                                          createVNode("td", { class: "border border-gray-300 px-2 text-center" }, toDisplayString(list.quantity), 1),
                                          createVNode("td", { class: "border border-gray-300 px-2" }, toDisplayString(formatRupiah(list.total_price)), 1)
                                        ]);
                                      }), 128))
                                    ])
                                  ])
                              ...
                              createVNode("tr", { class: "bg-white border-b dark:bg-gray-800 dark:border-gray-700" }, [
                                ...
                                createVNode("td", { class: "px-6 py-4" }, toDisplayString(calculateTotalPrice(unref(form).listData)), 1)
                              ]),
                              createVNode("tr", { class: "bg-white border-b dark:bg-gray-800 dark:border-gray-700" }, [
                                createVNode("th", {
                                  scope: "row",
                    ...
                    createVNode("ol", { class: "inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse" }, [
                      ...
                      createVNode("li", { "aria-current": "page" }, [
                        createVNode("div", { class: "flex items-center" }, [
                          ...
                          createVNode("span", { class: "ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400" }, "Pembelian Persediaan")
                        ])
                      ])
                    ])
                  ])
