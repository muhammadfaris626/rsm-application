import { watch, computed, unref, withCtx, createTextVNode, mergeProps, createVNode, createBlock, openBlock, withModifiers, createCommentVNode, Fragment, renderList, toDisplayString, useSSRContext } from "vue";
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div></div><h1 class="text-xl font-semibold text-blue-600 my-2"${_scopeId}>TAMBAH BARANG</h1><div class="bg-white p-4 rounded-xl"${_scopeId}>`);
            if (unref(form).products.length > 0) {
              ...
              ssrRenderList(unref(form).products, (product, index) => {
                var _a;
                _push2(`<div${_scopeId}><div class="text-slate-800 flex w-full items-center rounded-md pt-2 pl-3 transition-all"${_scopeId}><h1 class="mr-2 text-lg font-semibold"${_scopeId}>${ssrInterpolate(index + 1)}.</h1><div class="grid grid-cols-5 gap-2 w-full"${_scopeId}><div class="col-span-2"${_scopeId}>`);
                _push2(ssrRenderComponent(unref(VueMultiselect), {
                  class: "bg-white",
            ...
            _push2(`<div class="flex-flex-row-reverse space-x-4 space-x-reverse justify-center"${_scopeId}><div class="text-center"${_scopeId}><button type="button" class="px-5 py-2 text-sm font-medium text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-center"${_scopeId}> Tambah Barang </button></div></div></div><div class="mt-6"${_scopeId}><button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"${_scopeId}>SIMPAN</button>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("sales.index"),
            ...
            return [
              createVNode("div", { class: "grid grid-cols-1 h-full" }, [
                    ...
                    createVNode("ol", { class: "inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse" }, [
                      ...
                      createVNode("li", { "aria-current": "page" }, [
                        createVNode("div", { class: "flex items-center" }, [
                          ...
                          createVNode("span", { class: "ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400" }, "Tambah Penjualan")
                        ])
                      ])
                    ])
                  ])
                ...
                createVNode("div", { class: "pt-4" }, [
                  createVNode("h1", { class: "text-xl font-semibold text-blue-600" }, "TAMBAH PENJUALAN"),
                  createVNode("form", {
                    ...
                    createVNode("h1", { class: "text-xl font-semibold text-blue-600 my-2" }, "TAMBAH BARANG"),
                        ...
                        createVNode("nav", { class: "flex flex-col gap-1 p-1.5" }, [
                          (openBlock(true), createBlock(Fragment, null, renderList(unref(form).products, (product, index) => {
                            ...
                            return openBlock(), createBlock("div", { key: index }, [
                              createVNode("div", { class: "text-slate-800 flex w-full items-center rounded-md pt-2 pl-3 transition-all" }, [
                              ...
                              ((_a = product.branch_product_id) == null ? void 0 : _a.stock) != null ? (openBlock(), createBlock("table", {
                                key: 0,
                                class: "table-auto text-xs ml-12 text-gray-500"
                              }, [
                                createVNode("tbody", null, [
                                  createVNode("tr", null, [
                                    createVNode("td", null, "Stok Tersedia"),
                                    createVNode("td", null, ":"),
                                    createVNode("td", null, toDisplayString(product.branch_product_id.stock), 1)
                                  ]),
                                  createVNode("tr", null, [
                                    createVNode("td", null, "Tanggal Barang"),
                                    createVNode("td", null, ":"),
                                    createVNode("td", null, toDisplayString(product.branch_product_id.tanggal), 1)
                                  ])
                                ])
