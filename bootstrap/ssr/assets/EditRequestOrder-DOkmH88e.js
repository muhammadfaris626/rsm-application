import { computed, watch, unref, withCtx, createTextVNode, createVNode, createBlock, openBlock, withModifiers, createCommentVNode, Fragment, renderList, toDisplayString, useSSRContext } from "vue";
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    ...
    const props = __props;
    const form = useForm({
      id: (_a = props.requestOrder) == null ? void 0 : _a.id,
      ro_number: (_b = props.requestOrder) == null ? void 0 : _b.ro_number,
      branch_id: (_c = props.requestOrder) == null ? void 0 : _c.branch_id,
      date: (_d = props.requestOrder) == null ? void 0 : _d.date,
      products: (_e = props.requestOrder) == null ? void 0 : _e.listData.map((item) => ({
        product_id: {
    ...
    const formattedProducts = computed(() => {
      return products.value.map((product) => {
        ...
        return {
          id: product.id,
          label: `${(_a2 = product.product_id) == null ? void 0 : _a2[0].product_name}`,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[-->`);
      _push(ssrRenderComponent(unref(Head), { title: "Ubah Permintaan Pesanan" }, null, _parent));
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div></li><li aria-current="page"${_scopeId}><div class="flex items-center"${_scopeId}><svg class="rtl:rotate-180 w-3 h-3 text-gray-400 mx-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10"${_scopeId}><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 9 4-4-4-4"${_scopeId}></path></svg><span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400"${_scopeId}>Ubah Permintaan Stok</span></div></li></ol></nav></div><div class="pt-4"${_scopeId}><h1 class="text-xl font-semibold text-blue-600"${_scopeId}>UBAH PERMINTAAN STOK</h1><form${_scopeId}><div class="grid grid-cols-3 gap-2 mt-2 bg-white p-4 rounded-xl"${_scopeId}><div${_scopeId}>`);
            ...
            _push2(ssrRenderComponent(_sfc_main$3, {
              ...
              modelValue: unref(form).ro_number,
              "onUpdate:modelValue": ($event) => unref(form).ro_number = $event,
              disabled: ""
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_sfc_main$4, {
              class: "mt-2",
              message: unref(form).errors.ro_number
            }, null, _parent2, _scopeId));
            ...
            if (unref(form).products.length > 0) {
              _push2(`<div class="relative flex flex-col rounded-lg bg-white shadow-sm border border-slate-200 mb-4"${_scopeId}><div class="flex flex-col gap-1 p-1.5"${_scopeId}><!--[-->`);
            ...
            return [
              createVNode("div", { class: "grid grid-cols-1 h-full" }, [
                    ...
                    createVNode("ol", { class: "inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse" }, [
                      ...
                      createVNode("li", { "aria-current": "page" }, [
                        createVNode("div", { class: "flex items-center" }, [
                          ...
                          createVNode("span", { class: "ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400" }, "Ubah Permintaan Stok")
                        ])
                      ])
                    ])
                  ])
                ...
                createVNode("div", { class: "pt-4" }, [
                  createVNode("h1", { class: "text-xl font-semibold text-blue-600" }, "UBAH PERMINTAAN STOK"),
                  createVNode("form", {
                    onSubmit: withModifiers(($event) => unref(form).put(_ctx.route("requestOrders.update", unref(form).id)), ["prevent"])
                  }, [
                    ...
                    createVNode("div", { class: "bg-white p-4 rounded-xl" }, [
                      unref(form).products.length > 0 ? (openBlock(), createBlock("div", {
                        ...
                        createVNode("div", { class: "flex flex-col gap-1 p-1.5" }, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Products/RequestOrders/EditRequestOrder.vue");
