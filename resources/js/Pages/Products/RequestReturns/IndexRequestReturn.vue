                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Permintaan Return</span>
                            </div>
                        </li>
                    </ol>
                </nav>
            ...
            <div class="flex justify-between my-3">
                ...
                <div>
                    <template v-if="hasPermission('request-return: create')">
                        <Link :href="route('requestReturns.create')" class="px-5 py-2.5 text-sm font-medium text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            ...
            <Table>
                ...
                <template #default>
                    <TableRow v-for="(data, index) in fetchData.data" :key="data.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <TableDataCell :status="'record'" class="font-bold">{{ data.request_order_id[0].ro_number }}</TableDataCell>
                        <TableDataCell :status="'record'" class="font-bold">{{ data.request_number }}</TableDataCell>
                        <TableDataCell :status="'record'">{{ data.branch_id.branch_name }}</TableDataCell>
                        ...
                        <TableDataCell :status="'action'">
                            ...
                            <template v-if="hasPermission('request-return: read')">
                                <button @click="modalRead(data)" class="text-white mr-1 bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm p-2 text-center inline-flex items-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800" type="button">
                            ...
                            <!-- <template v-if="hasPermission('request-return: update') && data.status =='Sedang diverifikasi'">
                                <Link :href="route('requestReturns.edit', data.id)" class="text-white mr-1 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm p-2 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-3 h-3">
                            ...
                            <template v-if="hasPermission('request-return: delete')">
                                <button @click="modalDelete(data)" type="button" class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm p-2 text-center inline-flex items-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-3 h-3">
