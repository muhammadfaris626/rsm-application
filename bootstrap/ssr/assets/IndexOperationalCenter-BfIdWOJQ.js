                ...
                if (_push3) {
                  ...
                  ssrRenderList(__props.fetchData.data, (data, index) => {
                    _push3(ssrRenderComponent(TableRow, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(_sfc_main$8, { status: "number" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                          ...
                          _push4(ssrRenderComponent(_sfc_main$8, { status: "record" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`${ssrInterpolate(formatRupiah(data.total_cost))}`);
                              } else {
                                return [
                                  createTextVNode(toDisplayString(formatRupiah(data.total_cost)), 1)
                                ];
                              }
                            }),
                            _: 2
                          ...
                          return [
                            createVNode(_sfc_main$8, { status: "number" }, {
                              default: withCtx(() => [
                                createTextVNode(toDisplayString(index + 1), 1)
                              ]),
                              _: 2
            ...
            return [
              createVNode("div", { class: "grid grid-cols-1 h-full" }, [
                    ...
                    createVNode("ol", { class: "inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse" }, [
                      ...
                      createVNode("li", { "aria-current": "page" }, [
                        createVNode("div", { class: "flex items-center" }, [
                          ...
                          createVNode("span", { class: "ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400" }, "Pusat")
                        ])
                      ])
                    ])
                  ])
                ...
                createVNode("div", { class: "flex justify-between my-3" }, [
                  ...
                  createVNode("div", null, [
                    unref(hasPermission)("operational-center: create") ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                      createVNode("button", {
