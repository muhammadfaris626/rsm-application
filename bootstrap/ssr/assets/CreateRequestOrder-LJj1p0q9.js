import { computed, unref, withCtx, createTextVNode, createVNode, createBlock, openBlock, withModifiers, createCommentVNode, Fragment, renderList, toDisplayString, useSSRContext } from "vue";
            ...
            return [
              createVNode("div", { class: "grid grid-cols-1 h-full" }, [
                    ...
                    createVNode("ol", { class: "inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse" }, [
                      ...
                      createVNode("li", { "aria-current": "page" }, [
                        createVNode("div", { class: "flex items-center" }, [
                          ...
                          createVNode("span", { class: "ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400" }, "Tambah Permintaan Stok")
                        ])
                      ])
                    ])
                  ])
                ...
                createVNode("div", { class: "pt-4" }, [
                  ...
                  createVNode("form", {
                    onSubmit: withModifiers(($event) => unref(form).post(_ctx.route("requestOrders.store")), ["prevent"])
                  }, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Products/RequestOrders/CreateRequestOrder.vue");
